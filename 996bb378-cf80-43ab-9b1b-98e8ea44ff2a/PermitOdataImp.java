...
class PermitODataImp implements Processor {
    ...
    class EData{
     ...
     class DataProvider {
         ...
         public DataProvider(EData[] eDataArray) throws JSONException {
         ...
         private EntityCollection createData(JSONArray records,FullQualifiedName ET_NAME) throws JSONException {
             ...
             for(int i = 0; i < records.length(); i++)
             {
                   ...
                   String[] elementNames = JSONObject.getNames(object);
                   ...
                   for (String elementName : elementNames)
                   {
                     ...
                     System.out.printf("name=%s, value=%s\n", elementName, value);
                      ...
                      el.addProperty(createPrimitive(elementName, value));
                   }
    ...
    public void process(Exchange exchange) throws Exception {
          ...
          String workordersJson = hash.get("PERMIT_KEY").toString();

          JSONArray workorderJSONObj = new JSONArray(workordersJson.trim());


            String NAMESPACE = "olingo.odata.customprovider";

            EData[] eData = new EData[]{new EData("permitdata",new FullQualifiedName(NAMESPACE, "permitdata"), workorderJSONObj) };
            DataProvider dataProvider = null;
             if (dataProvider == null) {
               dataProvider = new DataProvider(eData);
             }

             String[] workordercolumns = {"area1.DisplayValue","area2.DisplayValue","area3.DisplayValue","area4.DisplayValue","equipment.DisplayValue","logid","permit_type.DisplayValue"};  

             ODataEntity[] entities = new ODataEntity[]{ new ODataEntity(new FullQualifiedName(NAMESPACE, "permitdata"),"permitdata",workordercolumns)};
